...
@export var next_page_scene_res_path: String = "res://scenes/ui/credits/0-10/credits_9.tscn"
@export var previous_page_scene_res_path: String = "res://scenes/ui/credits/0-10/credits_7.tscn"
