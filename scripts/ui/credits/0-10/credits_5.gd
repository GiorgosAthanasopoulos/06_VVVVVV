...
@export var next_page_scene_res_path: String = "res://scenes/ui/credits/0-10/credits_6.tscn"
@export var previous_page_scene_res_path: String = "res://scenes/ui/credits/0-10/credits_4.tscn"
